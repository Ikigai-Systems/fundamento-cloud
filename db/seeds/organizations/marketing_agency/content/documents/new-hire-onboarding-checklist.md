...
Welcome to BrightPath Media! This checklist covers everything you need to complete during your first two weeks. Work through it at your own pace, but aim to have everything checked off by the end of week two. Your manager will check in with you along the way.

## Day 1 - Getting Set Up

- [ ] Complete HR paperwork and sign employment agreement
- [ ] Set up your Fundamento workspace account and join all three spaces
- [ ] Set up Slack and join the following channels: #general, #clients, #creative, #random
- [ ] Configure your company email and set your email signature
- [ ] Set up your calendar and add recurring team meetings
...
Do not hesitate to ask anyone on the team. We have all been the new person. Drop questions in Slack or add a comment to this document and someone will get back to you quickly.
