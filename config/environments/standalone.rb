...
Rails.application.configure do
  # Read secret_key_base from file generated by docker-entrypoint on first boot
  secret_file = Rails.root.join("config/credentials/secret_key_base")
  config.secret_key_base = File.read(secret_file).strip if File.exist?(secret_file)
